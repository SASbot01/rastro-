    ...
    <>
      ...
      <main className="mx-auto w-full max-w-[640px] lg:max-w-[920px] px-5 py-8 sm:py-12">
        ...
        <ul className="mt-6 grid gap-3 sm:grid-cols-2">
          <li><Link href="/ayuda-urgente" className={CARD + " block border-danger/30 hover:border-danger"}><span className="text-xs font-semibold text-danger">{tr("experience.emergency")}</span><h2 className="mt-1 text-base font-semibold">{tr("experience.emergencyTitle")}</h2><p className="mt-1.5 text-sm leading-relaxed text-muted">{tr("experience.emergencyBody")}</p></Link></li>
